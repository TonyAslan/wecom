...
//设置用户详情窗口展示信息 参数：名字、图片、邮箱、部门、电话号
void CUserDetailDlg::SetUserInfo(QString strName, QString ico, QString strEmail, QString strPart, QString strPhoneNumber)
{
	...
	m_labTelValue->setText(strPhoneNumber);
	m_labMailValue->setText(strEmail);
	m_labDepartmentValue->setText(strPart);
